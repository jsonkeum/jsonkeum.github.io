            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "p",
                        null,
                        "I am a detail oriented problem solver and a new full-stack web developer seeking a growing role with a B2B or B2C tech startup. Formerly I worked as lawyer in New York focusing on labour and employment litigation and e-discovery. As a long time power user of a variety of business applications, I am interested in developing practical solutions that strongly consider the needs of the end user."
                    ),
                    React.createElement("br", null),
                    React.createElement(
                        "p",
                        null,
                        "I started programming in May 2016 knowing absolutely zero about development. Through initiative and disciplined self-learning (and patience) I can now build and deploy MERN-stack single page apps from scratch! I\u2019ve taken some college courses on algorithms, systems analysis and OOP (Java), but most of what I know is self-taught. While I still have much more to learn, I am enjoying every minute of the journey."
                    ),
                    React.createElement("br", null),
                    React.createElement(
                        "p",
                        ...
                        React.createElement(
                            "a",
                            { href: "https://www.linkedin.com/messaging/compose/", target: "_blank" },
                            "shoot me a message"
                        ),
                        " if you'd like to connect over all things tech. Cheers!"
                    ),
                    React.createElement("br", null),
                    React.createElement(
                        "p",
